...
@Aspect
@Component
@Slf4j //  Same ->  Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
...
//    Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
    ...
    @Pointcut("execution(* com.example.controller.ProjectController.*(..)) || execution (* com.example.controller.TaskController.*(..))")
